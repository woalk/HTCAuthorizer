...
/*
** From xHangouts Module:
*  SettingsProvider takes our shared preferences and broadcasts them
*  for other classes to see, as XSharedPreferences are somewhat finnicky
*  by comparison.  This is a more robust and reliable way of keeping
*  all of our gears in synch - as well as providing Module info to
*  other apps.
*
*/
...
public final class SettingsProvider extends ContentProvider {
    ...
    static final String AUTHORITY = "com.woalk.HTCAuthorizer.settings";
